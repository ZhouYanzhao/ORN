...
void BNLayer<Dtype>::Forward_gpu(const vector<Blob<Dtype>*>& bottom,
  ...
  caffe_gpu_gemv<Dtype>(CblasNoTrans, num_ * channels_, spatial_num_, Dtype(1. / (spatial_num_)), const_bottom_data,
  ...
  caffe_gpu_gemm<Dtype>(CblasNoTrans, CblasNoTrans, num_ * channels_, spatial_num_, 1, Dtype(-1),
  ...
  // statistic across spatial
  caffe_gpu_gemv<Dtype>(CblasNoTrans, num_ * channels_, spatial_num_, Dtype(1. / (spatial_num_)), buffer_blob_.gpu_data(),
    spatial_sum_multiplier_.gpu_data(), Dtype(0), spatial_statistic_.mutable_gpu_data());
  // statistic across batch
  caffe_gpu_gemv<Dtype>(CblasTrans, num_, channels_, Dtype(1. / num_), spatial_statistic_.gpu_data(),
    batch_sum_multiplier_.gpu_data(), Dtype(0), batch_statistic_.mutable_gpu_data());
...
void BNLayer<Dtype>::Backward_gpu(const vector<Blob<Dtype>*>& top,
  ...
  // statistic across spatial
  caffe_gpu_gemv<Dtype>(CblasNoTrans, num_ * channels_, spatial_num_, Dtype(1), buffer_blob_.gpu_data(),
    spatial_sum_multiplier_.gpu_data(), Dtype(0), spatial_statistic_.mutable_gpu_data());
  // statistic across batch
  ...
  // statistic across spatial
  caffe_gpu_gemv<Dtype>(CblasNoTrans, num_ * channels_, spatial_num_, Dtype(1), const_top_diff,
    spatial_sum_multiplier_.gpu_data(), Dtype(0), spatial_statistic_.mutable_gpu_data());
  // statistic across batch
  caffe_gpu_gemv<Dtype>(CblasTrans, num_, channels_, Dtype(1), spatial_statistic_.gpu_data(),
  ...
  // statistic across spatial
  caffe_gpu_gemv<Dtype>(CblasNoTrans, num_ * channels_, spatial_num_, Dtype(1), const_bottom_diff,
    spatial_sum_multiplier_.gpu_data(), Dtype(0), spatial_statistic_.mutable_gpu_data());
  // statistic across batch
  caffe_gpu_gemv<Dtype>(CblasTrans, num_, channels_, Dtype(1), spatial_statistic_.gpu_data(),
    batch_sum_multiplier_.gpu_data(), Dtype(0), batch_statistic_.mutable_gpu_data());
  ...
  caffe_gpu_axpby(buffer_blob_.count(), Dtype(1), buffer_blob_.gpu_data(), Dtype(-1. / (num_ * spatial_num_)),
    bottom_diff);
